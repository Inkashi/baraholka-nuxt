...
urlpatterns = [
    ...
    path('getLogs/', getLogs.as_view(), name='getLogs'),
    path('countRegisterToChat/', countRegisterToChat.as_view(), name='countRegisterToChat'),
    path('getStatsLogs/', getStatsLogs.as_view(), name='getStatsLogs'),
